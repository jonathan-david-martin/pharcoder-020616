 ...
 *     define APIs.  When called it is passed the code object and the
 *     global scope object.
 * @constructor
 */
...
/**
 * Execute the code to program completion.
 */
...
Interpreter.prototype['stepExpressionStatement'] = function() {
  ...
  if (!state.done) {
    ...
    this.stateStack.shift();
    // Save this value to the code for use as a return value if
